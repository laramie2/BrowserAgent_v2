#!/usr/bin/env python3
"""Run the configured evaluation matrix through run_eval_all.sh."""
...
DEFAULT_CONFIG = ROOT / "experiments" / "eval_matrix.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Extra run_eval_all.sh arguments after --.",
    )
