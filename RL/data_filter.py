...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=str, default=str(PROJECT_ROOT / "RL/filter_results"))
    parser.add_argument("--system_prompt", type=str, default=None)
    parser.add_argument("--env_url", type=str, default="http://localhost:5000/get_observation")
    parser.add_argument("--base_url", type=str, default="http://localhost:8008/v1/")
    parser.add_argument("--api_key", type=str, default="EMPTY")
    parser.add_argument("--model", type=str, default="custom-llm-1")
...
cd /data/yutao/lzt/BrowserAgent_v2
...
python RL/data_filter.py \
  ...
  --output_dir RL/filter_results/sft_rollout_k8 \
