...
def build(args: argparse.Namespace) -> None:
    ...
    scores = []
    score_files = args.score_file or [str(path) for path in DEFAULT_SCORE_FILES]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", "--output_dir", dest="output_dir", type=Path, default=RL_DIR / "dataset")
