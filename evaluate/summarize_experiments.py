...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=ROOT / "evaluate" / "configs" / "eval_matrix.json")
    parser.add_argument(
        "--results-root",
        type=Path,
        default=ROOT / "evaluate" / "results" / "experiments",
    )
    parser.add_argument("--output-dir", type=Path, default=ROOT / "evaluate" / "reports")
