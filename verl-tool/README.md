...
+ [2025/06/16] We updated the bundled verl implementation to the 06/16 version and adapted it for verl-tool.
...
- 🔧 **Complete decoupling of actor rollout and environment interaction** - This repository includes a localized verl implementation so that project-specific changes are versioned together. All tool calling is integrated via a unified API, allowing you to add and test tools independently.
