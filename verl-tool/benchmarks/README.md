...
Benchmark implementations are optional and are not bundled with BrowserAgent
v2. Clone only the repositories needed for an evaluation into this directory.
The checkout commands below reproduce the revisions previously used by
verl-tool:

```bash
# Adapted math-evaluation-harness
git clone https://github.com/Zhuofeng-Li/math-evaluation-harness.git math-evaluation-harness
git -C math-evaluation-harness checkout 9271e69bece4d14b33340df050c469996f1d6ab1

# Adapted BigCodeBench
git clone https://github.com/jdf-prog/bigcodebench.git bigcodebench
git -C bigcodebench checkout eb400cdfaba72ae9868338a3710459034211469f

# Adapted evalplus
git clone https://github.com/jdf-prog/evalplus.git evalplus
git -C evalplus checkout 221984301dc2cace122baf11a937e5b7fe3069fb

# LiveCodeBench
git clone https://github.com/jdf-prog/LiveCodeBench.git LiveCodeBench
git -C LiveCodeBench checkout 125a8de39b2d88f214fbde8a22d034a04f774d11

# MCP-Universe
git clone https://github.com/ShenzheZhu/MCP-Universe.git MCP-Universe
git -C MCP-Universe checkout 326d29e2c05c900fd45eef524700ecc04c142b8a
```
